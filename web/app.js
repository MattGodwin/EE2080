...
const scenes={
  councilHome1:{
    ...
    dialogue:[ {text:"This house is always so cold during winter....", speaker:"Council Tenant"},
    {text: "But the heating prices have been really high lately. I dont know if I can afford to turn the heating up anymore.", speaker:"Council Tenant"},
    {text: "Should I really turn the heating up?", speaker:"Council Tenant",
      choices:[{text:"Turn up the heating and get warm", action:"getWarm"}, {text:"Leave the heating and stay cold", action:"stayCold"}]},
    {text:"ONE MONTH LATER", speaker:""},
    {text: "I wonder what's in the post today...", speaker:"Council Tenant",choices:[{text:"Check the post", next:"highBills"}]}]
  },
  highBills:{
    image: "./images/high_bills.webp",    
    dialogue:[ {text:"How could this bill be so high!?", speaker:"Council Tenant"},
    {text: "How are we supposed to heat this house and still afford to eat.", speaker:"Council Tenant"}, 
    {text:"If we didn't cut our food expenses this month, we would never be able to afford this gas bill.", speaker:"Council Tenant",choices:[{text:"Pay the bill", action:"Pay bill"}]}, 
    {text:"I don't understand how they expect us to keep living like this", speaker:"Council Tenant", choices:[{text:"Next Letter", next:"councilBrochure"}]}],
    clickables:[{x:35, y:35, width:29, height:28, action:"computer brochure"} ]
  },
  lowBills:{
    image: "./images/low_bills.webp", 
    dialogue:[ {text:"The entire family has been freezing inside this house all month.", speaker:"Council Tenant"},
    {text: "But at least now we can afford our gas bill and still put some food on the table.", speaker:"Council Tenant", choices:[{text:"Pay the bill", action:"Pay bill"}]}, 
    {text: "I don't understand how they expect us to keep living like this", speaker:"Council Tenant", choices:[{text:"Next Letter", next:"councilBrochure"}]}],
    clickables:[{x:35, y:35, width:29, height:28, action:"computer brochure"} ]
  },
  councilBrochure:{
    image: "./images/decarbonising_brochure.webp", 
    dialogue:[ {text:"Oh... this one is from the council", speaker:"Council Tenant"},
    {text: "It's about decarbonising our house.", speaker:"Council Tenant"}, 
    {text: "I can barely afford to keep the heating on now! Won't this just make things worse?", speaker:"Council Tenant"}, 
    {text: "Maybe I should give them a call...", speaker:"Council Tenant", choices:[{text:"Call the council", action:"called"}, {text:"Don't call the council", action:"notCalled"}]}, 
    {text: "What does the council even do!?", speaker:"Council Tenant", choices:[{text:"Play as the Council", next:"councilOffice1"}]}],
    clickables:[{x:35, y:35, width:29, height:28, action:"computer brochure"} ]
  },
  councilOffice1:{
  ...
  councilOffice2:{
    image: "./images/council_office_notify.webp", 
     dialogue:[ {text:"Oh! Theres a new notification!", speaker:"Council Worker"},
     {text: "That might be an announcement of the new policy.", speaker:"Council Worker"},
     {text: "reading.....reading.....reading....reading", speaker:"Council Worker"}, 
  ...
  councilOffice3:{
    image: "./images/council_office.webp", 
     dialogue:[ {text:"PRESENT DAY", speaker:""},
     {text: "Now that we've started promoting our decarbonisation efforts, I should try directly contacting our tenants to assess their EPC rating and eligibility.", speaker:"Council Worker", choices:[{text:"Call Tenants", next:"councilCall1"}]}],
    clickables:[{x:75, y:12, width:20, height:30, action:"to be added"}, {x:5, y:56, width:17, height:12, action:"something else"}, ]
  },
  councilCall1:{
    image: "./images/tenant_council_call.webp", 
    dialogue:[ {text:"Hello council tenant, this is council worker calling from your local council about potentially upgrading the heating in your home as part of our decarbonisation efforts.", speaker:"Council Worker"},
    {text: "Yes, hello council worker. I saw your brochure but I'm confused about what these decarbonisation efforts would mean for me.", speaker:"Council Tenant"}, 
    {text: "Well, decarbonising council housing doesnt have a one size fits all solution.", speaker:"Council Worker"}, 
  ...
  outsideHome:{
    ...
    {text: "Should we head inside and look around now?", speaker:"Council Worker", choices:[{text:"Lets Go!", next:"councilHome2"}]}],
    clickables:[{x:35, y:35, width:29, height:28, action:"computer brochure"} ]
  }, 
  councilHome2:{
    image: "./images/council_in_house.webp", 
    dialogue:[ {text:"Do you want to start having a look around and I will note down your assesments?", speaker:"Council Worker"},
    {text: "Yes, I'll go poke around the house.", speaker:"Unnamed Independent Assessor"}, 
    {text: "Have you finished exploring the property?",speaker:"", choices:[{text:"Yes, lets move on", next:"councilOffice4"}, {text:"No,not yet", action:"nothing", stay:true}]}],
     clickables:[{x:75, y:12, width:20, height:30, action:"window"}, {x:2, y:10, width:10, height:40, action:"wall"},
       {x:37, y:90, width:60, height:10, action:"floor"}, {x:40, y:0, width:30, height:10, action:"loft"}]
  },
  councilOffice4:{
    image: "./images/council_office.webp", 
    dialogue:[ {text:"TWO DAYS LATER", speaker:""},
    {text: "The EPC rating for the council tenant property has now been confirmed as a EPC D rating.", speaker:""}, 
    {text: "Now that it qualifies for the scheme, let's decide on the decarbonisation plan for council tenant's property.", speaker:"Council Worker"}, 
    {text: "Should we first focus on upgrading the materials making up the buildings fabric?", speaker:"", choices:[{text:"Let's do 'Fabric First'", action:"fabricYes"}, {text:"Too expensive, just fix the heating",action:"fabricNo"}, {text:"Learn More",action:"fabricMore", stay:true}]}, 
    {text: "Select yes or no for each of the following 'fabric first' upgrades. Extra information about each upgrade is available by choosing Learn More", speaker:""}, 
    {text: "Loft Insulation?", speaker:"", choices:[{text:"Install Loft Insulation", action:"loftYes"}, {text:"Reject Loft Insulation",action:"nothing"}, {text:"Learn More",action:"loftMore", stay:true}]},
    {text: "Floor Insulation?", speaker:"", choices:[{text:"Install Floor Insulation", action:"floorYes"}, {text:"Reject Floor Insulation",action:"nothing"}, {text:"Learn More",action:"floorMore", stay:true}]}, 
    {text: "Cavity Wall Insulation?", speaker:"", choices:[{text:"Install Cavity Wall Insulation", action:"cwYes"}, {text:"Reject Cavity Wall Insulation",action:"cwNo"}, {text:"Learn More",action:"cwMore", stay:true}]}, 
    {text: "Improve Air Tightness?", speaker:"", choices:[{text:"Yes Improve it", action:"atYes"}, {text:"Leave It As Is",action:"nothing"}, {text:"Learn More",action:"atMore", stay:true}]}, 
    {text: "Add Internal or External Wall Insulation?", speaker:"", choices:[{text:"Install Internal Wall Insulation", action:"intYes"}, {text:"Install External Wall Insulation",action:"extYes"}, {text:"Skip Both Upgrades",action:"nothing"}, {text:"Learn More",action:"int_extMore", stay:true}]},
  ...
  councilCall2:{
    ...
    {text: "I know this does not sound appealing in the short term, but after the upgrades are complete your home will be warmer for less.", speaker:"Council Worker"}, 
    {text: "You will also be doing your part in fighting against global warming!", speaker:"Council Worker"}, 
    {text: "I told you the first time you called! I dont care about all your 'upgrades'. *CLICK*", speaker:"Council Tenant", choices:[{text:"Convince The Tenant", next:"quiz"}]}],
    clickables:[{x:35, y:35, width:29, height:28, action:"computer brochure"} ]
  }, 
  goodEnd:{
...
function ChooseAction(action){
  ...
  let temp3;
  if(action === "getWarm"){
    temp1 = scenes.councilHome1.dialogue.find(c => c.text==="I wonder what's in the post today..." );
  ...
  if(action === "called"){
    temp1 = scenes.councilOffice3.dialogue.find(c => c.text==="Now that we've started promoting our decarbonisation efforts, I should try directly contacting our tenants to assess their EPC rating and eligibility." );
    temp1.text = "*ring*....*ring*....*ring*";
    temp1.choices[0].text = "Answer The Phone";
    scenes.councilCall1.dialogue[0].text = "Thank you for calling us council tenant";
    scenes.councilCall1.dialogue[scenes.councilCall1.dialogue.length-1].text = "Ok, then I'll make some time for you and your contractor to stop by!";
    temp2 = scenes.outsideHome.dialogue.find(c => c.text==="That's a good thing too, they didn't seem too receptive when I contacted them.");
    temp2.text = "It's a shame though, they seemed like they would be very interested in the decarbonisation efforts.";
  }
  if(action === "notCalled"){state.isQuiz = 1;}
  if(action === "Pay bill"){
    state.houseBudget -= state.bills;
    document.getElementById("houseBudget").innerHTML = "Household Budget: £"+ state.houseBudget.toLocaleString();;
  }
  if(action === "fabricNo"){currentDialogue+=7}
  ...
  if(action === "intYes"){ApplyUpgrade("Internal wall insulation")}
  if(action === "int_extMore"){Popup("About Internal and External Wall Insulation",
  ...
  if(action === "extYes"){ApplyUpgrade("External wall insulation")}
  if(action === "ventYes"){ApplyUpgrade("Ventilation")}
  if(action === "ventMore"){Popup("About Ventilation Upgrade",
  ...
  if(action === "heatMore"){Popup("About Heating Upgrades","heres another popup")}
  if(action === "airYes"){ApplyUpgrade("Air source heat pump")}
  if(action === "groundYes"){ApplyUpgrade("Ground source heat pump")}
  if(action === "hnYes"){ApplyUpgrade("Heat network")}
  if(action === "hybYes"){ApplyUpgrade("Hybrid heat pump")}
  if(action === "upgMore"){Popup("About Heating Upgrade Options","heres another popup")}
  if(action === "upgMore"){return}
...
function DoClickable(action){
  if(action === "loft"){
    Popup("The Loft","Did you know an uninsulated home loses 25% of it's heat via the roof!");}
  if(action == "floor"){
